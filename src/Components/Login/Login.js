              ...
              >
                ...
                <div className='customUser'>
                  ...
                  <div className="form-group">
                    <button className="btn btn-outline-dark text-primary" style={{ width: '100%' }} variant='warning' type='submit' >Login</button>
                  </div>
                ...
                <div className='social-login'>
                  <button className="btn btn-light text-dark" onClick={fbSignIn}>
                    <img align="left" src={facebookIcon} alt='facebook icon' />{' '}
                    <span>Continue with Facebook</span>
                  </button>
                  <button className="btn btn-light text-dark" onClick={googleSignIn}>
